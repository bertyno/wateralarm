...
insert into T_RECORD (ID, R_DATE, HUMIDITY, PLANT_ID) values (NEXT VALUE FOR S_PLANT_ID, NOW(),10, 1 );
insert into T_RECORD (ID, R_DATE, HUMIDITY, PLANT_ID) values (NEXT VALUE FOR S_PLANT_ID, NOW(),15, 1 );
insert into T_RECORD (ID, R_DATE, HUMIDITY, PLANT_ID) values (NEXT VALUE FOR S_PLANT_ID, '2015-01-01',20, 1 );
insert into T_RECORD (ID, R_DATE, HUMIDITY, PLANT_ID) values (NEXT VALUE FOR S_PLANT_ID, '2015-01-01',30, 1 );
insert into T_RECORD (ID, R_DATE, HUMIDITY, PLANT_ID) values (NEXT VALUE FOR S_PLANT_ID, '2015-01-01',40, 1 );
insert into T_RECORD (ID, R_DATE, HUMIDITY, PLANT_ID) values (NEXT VALUE FOR S_PLANT_ID, '9999-12-31',9, 1 );
insert into T_RECORD (ID, R_DATE, HUMIDITY, PLANT_ID) values (NEXT VALUE FOR S_PLANT_ID, '2015-01-01',10, 2 );
insert into T_RECORD (ID, R_DATE, HUMIDITY, PLANT_ID) values (NEXT VALUE FOR S_PLANT_ID, '2015-01-01',15, 2 );
insert into T_RECORD (ID, R_DATE, HUMIDITY, PLANT_ID) values (NEXT VALUE FOR S_PLANT_ID, NOW(),20, 2 );
